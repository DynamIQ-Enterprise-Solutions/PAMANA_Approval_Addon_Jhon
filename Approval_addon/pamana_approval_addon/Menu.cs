...
namespace pamana_approval_addon
{
    class Menu
    {
        public void AddMenuItems()
        {
            ...
            try
            {
                ...
                oMenuItem = Application.SBO_Application.Menus.Item("pamana_approval_addon");
                oMenus = oMenuItem.SubMenus;

                // Create s sub menu
                oCreationPackage.Type = SAPbouiCOM.BoMenuType.mt_STRING;
                oCreationPackage.UniqueID = "pamana_approval_addon.Form1";
    ...
    **/
        ...
        public void SBO_Application_MenuEvent(ref SAPbouiCOM.MenuEvent pVal, out bool BubbleEvent)
        {
            ...
            try
            {
                if (pVal.BeforeAction && pVal.MenuUID == "pamana_approval_addon")
                {
